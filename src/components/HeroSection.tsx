    ...
    <Spotlight
      ...
      />    
        ...
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum at nisi quae delectus quam nesciunt, eum eius libero assumenda iure perferendis, nihil temporibus soluta hic, nobis excepturi a nam odit.</p>
            <div className="mt-4">
                <Link href={'/courses'}>
                    <Button 
